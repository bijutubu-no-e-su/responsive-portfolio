...
},{"swiper":2}],4:[function(require,module,exports){
"use strict";
...
/*#__PURE__*/
function () {
  function ScrollObserver(elements, cb, options) {
...
var _heroSlider = require("./libs/hero-slider");

var _scrollObserver = require("./libs/scroll-observer");

var _mobileMenu = require("./libs/mobile-menu");

var _paceJs = _interopRequireDefault(require("pace-js"));
...
function () {
  ...
  _createClass(Main, [{
    ...
    value: function _init() {
      ...
      this.hero = new _heroSlider.HeroSlider(".swiper-container");
      setTimeout(function () {
        _this.hero.stop();
      }, 15000);

      _paceJs["default"].on("done", this._paceDone.bind(this));
    }
  }, {
    ...
    value: function _scrollInit() {
      this.observers = new _scrollObserver.ScrollObserver(".swiper-container", this._toggleSlideAnimation.bind(this), {
        once: false
      });
    }
  }, {
...
},{"./libs/hero-slider":3,"./libs/mobile-menu":4,"./libs/scroll-observer":5,"pace-js":1}]},{},[6]);
