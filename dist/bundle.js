...
},{"swiper":3}],5:[function(require,module,exports){
"use strict";
...
exports.TweenTextAnimation = exports.TextAnimation = void 0;
...
function () {
  function TextAnimation(el) {
    ...
    console.log("textAnimation:".concat(this.DOM.el.innerHTML));
...
var TweenTextAnimation =
/*#__PURE__*/
function (_TextAnimation) {
  ...
  function TweenTextAnimation(el) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(TweenTextAnimation).call(this, el));
...
exports.TweenTextAnimation = TweenTextAnimation;

},{"gsap":1}],8:[function(require,module,exports){
"use strict";
...
var _textAnimation2 = require("./libs/text-animation");
...
function () {
  ...
  _createClass(Main, [{
    ...
    value: function _textAnimation(el, inview) {
      if (inview) {
        var ta = new _textAnimation2.TweenTextAnimation(el);
        ta.animate();
      }
    }
  }, {
    ...
    value: function _clickInit() {
      this.sections.forEach(function (section) {
        return section.addEventListener("click", function () {
          var detail = section.querySelector(".".concat(section.className, "__detail"));
          section.classList.toggle("clicked");
          console.dir("clicked:".concat(detail)); // console.log(section.className);
    ...
    value: function _scrollInit() {
      ...
      this.observers = new _scrollObserver.ScrollObserver(".tween-animate-title", this._textAnimation);
      this.observers = new _scrollObserver.ScrollObserver(".clicked", this._textAnimation);
      this.observers = new _scrollObserver.ScrollObserver(".appear", this._inviewAnimation);
    }
  }, {
    key: "observers",
...
},{"./libs/hero-slider":4,"./libs/mobile-menu":5,"./libs/scroll-observer":6,"./libs/text-animation":7,"pace-js":2}]},{},[8]);
